...
function setup() {
    ...
    createA("gallery.html", "gallery").parent("vinculos");
...
function portada() {
    createSpan(", estai en index po").parent("title");
    select("a:nth-child(1)").style("font-weight", "bold").style("color", "#000000");
}
function pagina() {
    createSpan(", estai en page po").parent("title");
    select("a:nth-child(2)").style("font-weight", "bold").style("color", "#000000");
}
function gallery() {
    createSpan(", ahora estai en gallery jajaja").parent("title");
